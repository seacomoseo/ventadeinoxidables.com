...
En cumplimiento de la obligación prevista por el artículo 14 del Reglamento (UE) 2016/679, de 27 de abril, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de esos datos, en adelante, Reglamento Europeo de Protección de Datos (RGPD), le informamos de que estamos procediendo al tratamiento de datos personales que usted nos ha facilitado, conforme a los principios de licitud, lealtad y transparencia, limitación de la finalidad y plazo de conservación, minimización de datos, exactitud, integridad y confidencialidad, entre otros, así como respetando el resto de obligaciones y garantías establecidas en la Ley Orgánica, 3/2018, de 5 de diciembre, de Protección de Datos y Garantías de Derechos Digitales (LOPDGDD) y Ley 9/2014, de 9 de mayo, de Telecomunicaciones y Ley 34/2002, de 11 de julio, de servicios de la sociedad de la información y de comercio electrónico y de acuerdo con las finalidades y en las condiciones descritas a continuación.

La presente Política de Privacidad es aplicable al tratamiento de datos personales por parte de **{{< legal name >}}** dentro de su web, Apps y cualquier otra plataforma digital o medio electrónico en las que se traten datos personales. Esta política será igualmente aplicable, en aquello que pudiera afectar, al tratamiento de datos de clientes de redes sociales sobre los que **{{< legal name >}}** realizase un tratamiento de sus datos y en función de su relación con **{{< legal name >}}**
...
Esta Política de Privacidad se irá actualizando, pero cada vez que hagamos un cambio lo publicaremos en nuestro sitio web.

Última actualización: 18 de enero de 2023.

Somos una empresa que ha nacido con la intención de satisfacer las necesidades de nuestros clientes tanto actuales como potenciales, para ello contamos con un equipo humano de profesionales, cada uno especializado en su terreno, con el fin de brindar a nuestro cliente una experiencia enriquecedora. Por tanto, el respeto a tu privacidad es fundamental para nosotros por lo que queremos informarte con toda transparencia de los tratamientos que podemos realizar con tus datos personales a fin de que puedas tomar una decisión al respecto. Por ello, te pedimos que dediques unos instantes a la lectura de esta Política de Privacidad.

## ¿Quién es el Responsable del tratamiento de sus datos?

### Identidad del responsable del tratamiento:

- **{{< legal name >}}** provisto de NIF **{{< legal dni >}}**
